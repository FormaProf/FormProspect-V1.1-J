...
class CRMFiltersBar(QWidget):
    ...
    def charger_options(self, options, pipelines_ordonnes=None, priorites_ordonnees=None):
        ...
        pipelines_source = options.get("pipeline", [])
        priorites_source = options.get("priorite", [])
        ...
        self.remplir_combo(self.commercial_filtre, "Commercial", options.get("commercial", []))
        self.remplir_combo(self.ville_filtre, "Ville", options.get("ville", []))
